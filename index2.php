...
<html lang="pt-br">
	<head>
		<meta charset="utf-8">
		<title>BAIXA DE ITENS</title>		
	</head>
	<body>
	<a href='http://26.243.0.64/central.php'><button>Página Central</button></a><br><br>
		
		<h1>BAIXA DE ESTOQUE DE ATAS</h1>
		<?php
		...
		while($row_usuario = mysqli_fetch_assoc($resultado_usuarios)){
			...
			echo "Pregao: " . $row_usuario['pregao'] . "<br>";
			echo "Ata: " . $row_usuario['ata'] . "<br>";
			echo "Unidade: " . $row_usuario['unidade'] . "<br>";
			echo "Item: " . $row_usuario['item'] . "<br>";
			echo "Descrição: " . $row_usuario['descricao'] . "<br>";
			echo "Quantidade: " . $row_usuario['quantidade'] . "<br>";
